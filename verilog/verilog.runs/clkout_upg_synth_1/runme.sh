...
HD_PWD='P:/CS214-Computer-Organization/Project-uart/verilog/verilog.runs/clkout_upg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkout_upg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkout_upg.tcl
