...
#
# Generated by Vivado on Fri May 26 23:29:09 +0800 2023
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="P:/CS214-Computer-Organization/CS214-Computer-Organization-Project/verilog/verilog.cache/compile_simlib/activehdl"
  fi
